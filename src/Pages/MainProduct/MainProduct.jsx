...
// handling shopbasket
  ...
  let mainProduct = mainData.find(item => item.id.trim() === params.ProductID.trim())
  let product=mainData.filter(item=>item.id.trim()===params.ProductID.trim())
  let productInBasket =authContext.shopBasket&& authContext.shopBasket.filter(item => item.id.trim() === params.ProductID.trim())
  let isInShopBasket=authContext.shopBasket&&authContext.shopBasket.some(item=>item.id.trim()===params.ProductID.trim())
