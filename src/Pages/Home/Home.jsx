            ...
            >
                ...
                <div className='p-2 md:p-5 bg-white dark:bg-zinc-700 shadow-normal rounded-2xl'>
                  ...
                  <div className=' flex items-center justify-between mt-2.5'>
                    <div className='flex items-center gap-x-2.5 md:gap-x-3'>
                      <span className='flex-center w-[26px] h-[26px] md:w-9 md:h-9 text-gray-400 bg-gray-100 dark:bg-zinc-800 hover:text-white hover:bg-teal-600 dark:hover:text-white dark:hover:bg-emerald-500 transition-all rounded-full cursor-pointer'>
              ...
              <SwiperSlide>
                <div className='p-2 md:p-5 bg-white dark:bg-zinc-700 shadow-normal rounded-2xl'>
                  ...
                  <div className='flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5'>
                    <div className='text-teal-600 dark:text-emerald-500'>
                      <span className='font-DanaDemiBold text-base md:text-xl'>175,000</span>
                      <span className='text-xs md:text-sm tracking-tighter'>تومان</span>
                    </div>
                  </div>
                  <div className=' flex items-center justify-between mt-2.5'>
